...
public class MemcachedClient
{
    ...
    private void Init(string poolName)
    {
    ...
    private static ResourceManager _resourceManager = new ResourceManager("Commons.StringMessages", typeof(MemcachedClient).Assembly);
